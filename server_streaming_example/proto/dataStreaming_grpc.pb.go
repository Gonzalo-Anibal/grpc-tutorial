...
func (c *streamingServiceClient) GetDataStreaming(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (StreamingService_GetDataStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamingService_ServiceDesc.Streams[0], "/server_streaming_example.StreamingService/GetDataStreaming", opts...)
	if err != nil {
		return nil, err
	}
...
var StreamingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server_streaming_example.StreamingService",
