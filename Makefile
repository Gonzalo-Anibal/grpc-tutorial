...
.DEFAULT_GOAL := help
.PHONY: greet blog calculator server_streaming_example user help
project := greet calculator blog server_streaming_example user
...
server_streaming_example: $@ ## Generate Pbs and build for server_streaming_example
...
clean: clean_greet clean_calculator clean_blog clean_server_streaming_example ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_server_streaming_example: ## Clean generated files for server_streaming_example
	${RM_F_CMD} server_streaming_example/${PROTO_DIR}/*.pb.go
